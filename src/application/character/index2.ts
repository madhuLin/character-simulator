...
// 			this.controls.moveForward(this.speed * delta_time);
...
// 			this.controls.moveRight(-this.speed * delta_time);
...
import { Scene, PerspectiveCamera, Vector3, BoxGeometry, MeshBasicMaterial, Mesh, Group } from "three";
import {PointerLockControls} from "three-stdlib";
import Control from "../control";
...
export default class Character {
    ...
    constructor(params: PlayerParams) {
        this.scene = params.scene;
        this.camera = params.camera;
        this.reset_position = new Vector3(-10, 2.5, 10);
		this.controls = params.controls;
		this.control = params.control;
		this.speed = params.speed!;
        this._createCharacterShape();
	...
	* */
    ...
    reset() {
        this.character_shape.position.copy(this.reset_position);
        this.camera.position.copy(this.reset_position);
